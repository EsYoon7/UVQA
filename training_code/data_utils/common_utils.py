...
def preprocess_multimodal_vlmrlaif(
...
def preprocess_multimodal_videollava(
    data_args: DataArguments,
    sources: Sequence[str],
    ...
    if not is_multimodal:
        return sources
    samples = preprocess_v1_UVQA(sources, tokenizer, has_image, mask_target, query_len, response_len, reward_model_prompt, image_captions)
    # return sources
    return samples
...
# added by esyoon 2024-09-13-18:56:06
def preprocess_v1_UVQA(
    sources,
    tokenizer: transformers.PreTrainedTokenizer,
    has_image: bool = False,
    mask_target: bool = True,
...
# added by esyoon 2025-02-19-16:04:24
def preprocess_llamavid_imgsp_v1(
    args,
    sources,
    tokenizer: transformers.PreTrainedTokenizer,
    has_image: bool = False,
...
def preprocess(
    ...
    if args.running_model_name == 'video-llava':
        return preprocess_multimodal_videollava(
            args,
            sources,
            tokenizer,
            has_image=has_image,
    ...
    elif args.running_model_name == 'llama-vid':
        return preprocess_llamavid_imgsp_v1(
            args,
            sources,
            tokenizer,
            has_image=has_image,
            ...
            query_len=query_len,
            response_len=response_len,
            refine_prompt=reward_model_prompt,
        )
